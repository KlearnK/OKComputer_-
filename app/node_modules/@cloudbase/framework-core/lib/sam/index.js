...
class SamManager {
    ...
    generate(meta, samSections) {
        let EntryPoint = samSections
            .map((sam) => sam === null || sam === void 0 ? void 0 : sam.EntryPoint)
            .reduce((prev, cur) => {
            prev = [...prev, ...(cur || [])];
            return prev;
        }, []);
        this.samObj = (0, lodash_merge_1.default)(default_sam_1.DEFAULT_SAM, meta, ...samSections, {
            EntryPoint,
        });
...
部署失败，错误信息：${taskInfo.Detail}， 请求RequestId：${statusRes.RequestId}`, error_1.ERRORS.DEPLOY_ERROR);
    ...
    uploadFileViaUrlAndKey(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, cloud_api_1.fetchStream)(url, {
                body: fs_1.default.createReadStream(file),
                headers,
                method: 'PUT',
            }, (0, toolbox_1.getProxy)());
        });
    }
    /**
     * 读取本地SAM
